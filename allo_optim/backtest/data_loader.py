...
from common.utils.data_cleaning import clean_price_data
            ...
            try:
                ...
                if len(batch_symbols) == 1:
                    ...
                    if hasattr(batch_data.columns, "levels") and len(batch_data.columns.levels) > 1:
                        ...
                        # Single level columns - just one symbol returned
                        if "Adj Close" in batch_data.columns and len(batch_symbols) == 1:
                            symbol = batch_symbols[0]
