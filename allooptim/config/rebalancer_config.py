...
class RebalancerConfig(BaseModel):
    ...
    filter_lifetime_days: Optional[int] = Field(default=20, ge=0, description="Number of days to keep trades in the filter")
    ...
    max_trades_per_day: Optional[int] = Field(default=15, ge=0, description="Maximum number of trades per day")
    trade_to_band_edge: bool = Field(default=True, description="Whether to trade to the band edge")
